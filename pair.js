...
const config = {
    ...
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> © CHALAH',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb5OiseHltY10IBkF112/1417',
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/letrek.jpg',
        MENU: 'https://files.catbox.moe/letrek.jpg',
        OWNER: 'https://files.catbox.moe/letrek.jpg',
        SONG: 'https://files.catbox.moe/letrek.jpg',
        VIDEO: 'https://files.catbox.moe/letrek.jpg'
    }
};
        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const title = '🪨 Hellow, *"Itz: CHALAH-MINI"*';
                    const content = `*© bY|* ChalaXz\n` +                                   `*◯ A B O U T*\n` +
                                   ...
                                   `*◯ D E P L O Y*\n` +
                                   `> *Webiste* https://chalah-md-mini-bot.vercel.app/`;
...
//=======================================
                ...
                case 'owner': {
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        caption: '*👑 CHALAH MD OWNER DETAILS*',
                        buttons: [
                            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📋 MENU' }, type: 1 },
